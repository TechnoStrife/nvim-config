return {
    {
        ...
        keys = {
            ...
            { "<leader>gl",  function() Snacks.lazygit.log() --[[Snacks.picker.git_log()]] end,             desc = "Git Log" },
            { "<leader>gL",  function() Snacks.picker.git_log_line() end,                                   desc = "Git Log Line" },
            { "<leader>gf",  function() Snacks.lazygit.log_file() --[[ Snacks.picker.git_log_file() ]] end, desc = "Git Log File" },
